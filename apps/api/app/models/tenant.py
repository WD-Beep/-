# 文件说明：后端数据库模型，定义业务数据表结构；当前文件：tenant
"""多租户：用户、工作区、产品/品牌。"""
...
class Product(Base):
    ...
    __table_args__ = (UniqueConstraint("workspace_id", "slug", name="uq_product_workspace_slug"),)
    ...
    created_source: Mapped[str | None] = mapped_column(String(32))
